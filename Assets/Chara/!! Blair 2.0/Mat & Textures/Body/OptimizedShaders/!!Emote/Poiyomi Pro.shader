Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/623cc7a5f4727db45a234c19e831f372"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_GLOBALMASKTEXTURE0) || !defined(OPTIMIZER_ENABLED)
				float4 gmcol0 = POI2D_SAMPLER_PAN(_GlobalMaskTexture0, _MainTex, poiUV(poiMesh.uv[(0.0 /*_GlobalMaskTexture0UV*/)], float4(1,1,0,0)), float4(0,1,0,0));
			...
			void calculateRGBNormals(inout PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				#if defined(PROP_RGBNORMALR) || !defined(OPTIMIZER_ENABLED)
				if ((1.0 /*_RgbNormalRScale*/) > 0 && (0.0 /*_RGBARedEnable*/))
				{
					float3 normalToBlendWith = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_RgbNormalR, _trilinear_repeat, poiUV(poiMesh.uv[(0.0 /*_RgbNormalRUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_RgbNormalRStochastic*/)), (0.0 /*_RgbNormalRedBlendMode*/) == 0 ? (1.0 /*_RgbNormalRScale*/) : (1.0 /*_RgbNormalRScale*/) * maskFinal.r);
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				RGBABlendColor(poiFragData, globalMaskBlend(rgbMask[(0.0 /*_RgbRedMaskChannel*/)], (0.0 /*_RgbRedGlobalMaskChannel*/), (2.0 /*_RgbRedGlobalMaskBlendType*/), poiMods), red, (0.0 /*_RGBARedEmissionStrength*/), (0.0 /*_RGBARedBlendType*/), (0.0 /*_RedAlphaAdd*/), (0.0 /*_RGBARedEnable*/));
				...
				if ((0.0 /*_RGBAPBRRedEnabled*/) || (0.0 /*_RGBAPBRGreenEnabled*/) || (0.0 /*_RGBAPBRBlueEnabled*/) || (0.0 /*_RGBAPBRAlphaEnabled*/))
				{
					...
					if ((0.0 /*_RGBARedPBRSplitMaskSample*/) && (0.0 /*_RGBAPBRRedEnabled*/) && (0.0 /*_RGBARedEnable*/))
					{
					...
					poiFragData.smoothness = lerp(poiFragData.smoothness, poiInvertToggle(smoothnessMaps.r, (0.0 /*_RGBARedSmoothnessInvert*/)), rgbMask[(0.0 /*_RgbRedMaskChannel*/)] * ((0.0 /*_RGBAPBRRedEnabled*/) && (0.0 /*_RGBARedEnable*/)));
					...
					poiFragData.metallic = lerp(poiFragData.metallic, poiInvertToggle(metallicMaps.r, (0.0 /*_RGBARedMetallicInvert*/)), rgbMask[(0.0 /*_RgbRedMaskChannel*/)] * ((0.0 /*_RGBAPBRRedEnabled*/) && (0.0 /*_RGBARedEnable*/)));
			...
			struct PoiDecal
			{
				...
				float m_DecalBlendAlpha_2121Emote;
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_2121Emote + audioLinkDecalAlpha);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_MatcapUVMode*/), (1.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.274 /*_MatcapRotation*/), (1.13 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (1.0 /*_MatcapNormal*/), matcapALD);
				...
				#endif
				matcapIntensity = (1.56 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.35 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (1.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
