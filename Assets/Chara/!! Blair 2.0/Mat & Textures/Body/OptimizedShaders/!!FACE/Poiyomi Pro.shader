Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/015c602b0bd16d4458fca4006661d344"
{
	Properties
	{
		...
		_DecalBlendAlpha_2121FACE ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha1_2121FACE ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha_2121FACE;
			...
			float _DecalBlendAlpha1_2121FACE;
			...
			struct PoiDecal
			{
				...
				float m_DecalBlendAlpha_2121FACE;
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_2121FACE + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha_2121FACE = _DecalBlendAlpha_2121FACE;
				...
				Decal1.m_DecalBlendAlpha_2121FACE = _DecalBlendAlpha1_2121FACE;
				...
				Decal2.m_DecalBlendAlpha_2121FACE = (1.0 /*_DecalBlendAlpha2*/);
				...
				Decal3.m_DecalBlendAlpha_2121FACE = (1.0 /*_DecalBlendAlpha3*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - ((-0.18 /*_Saturation*/)) * hueShiftAlpha.b);
