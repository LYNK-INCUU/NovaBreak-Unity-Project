Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/6de0cbe05706dea4cbcee9567badc01e"
{
	Properties
	{
		...
		_DecalBlendAlpha_2121SKIN ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha1_2121SKIN ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha3_2121SKIN ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha_2121SKIN;
			...
			float _DecalBlendAlpha1_2121SKIN;
			...
			float _DecalBlendAlpha3_2121SKIN;
			...
			struct PoiDecal
			{
				...
				float m_DecalBlendAlpha_2121SKIN;
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_2121SKIN + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha_2121SKIN = _DecalBlendAlpha_2121SKIN;
				...
				Decal1.m_DecalBlendAlpha_2121SKIN = _DecalBlendAlpha1_2121SKIN;
				...
				Decal2.m_DecalBlendAlpha_2121SKIN = (1.0 /*_DecalBlendAlpha2*/);
				...
				Decal3.m_DecalRotation = (309.0 /*_DecalRotation3*/);
				Decal3.m_DecalScale = float4(0.05,0.058,1,0);
				Decal3.m_DecalSideOffset = float4(0,0,0,0);
				Decal3.m_DecalPosition = float4(0.53,0.86,0,0);
				Decal3.m_DecalRotationSpeed = (0.0 /*_DecalRotationSpeed3*/);
				Decal3.m_DecalEmissionStrength = (0.0 /*_DecalEmissionStrength3*/);
				Decal3.m_DecalBlendAlpha_2121SKIN = _DecalBlendAlpha3_2121SKIN;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - ((-0.45 /*_Saturation*/)) * hueShiftAlpha.b);
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.17 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (1.0 /*_RimWidth*/), (1.0 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(1,1,1,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (0.0 /*_RimHueShiftSpeed*/),  (0.0 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (0.1 /*_RimBrightness*/), (1.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
