Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/b324f5d2aed72ba4f807f2be83151deb"
{
	Properties
	{
		...
		_Matcap3HueShift_2121Hair0 ("Hue Shift", Range(0, 1)) = 0
		...
		_GlitterHueShift_2121Hair0 ("Hue Shift", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _Matcap3HueShift_2121Hair0;
			...
			float _GlitterHueShift_2121Hair0;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					matcap3.rgb = hueShift(matcap3.rgb, _Matcap3HueShift_2121Hair0 + _Time.x * (0.0 /*_Matcap3HueShiftSpeed*/), (0.0 /*_Matcap3HueShiftColorSpace*/));
				}
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (int glitterLayer = 0; glitterLayer < (2.0 /*_GlitterLayers*/); glitterLayer++)
				{
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						if ((4.06 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (32.0 /*_GlitterAngleRange*/), (4.06 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
						...
						float brightness = (sin((_Time.x * 10 + randomOffset +glitterSpeedOffset) * (4.06 /*_GlitterSpeed*/)) * .5 + .5);
					...
					{
						glitterColor.rgb = hueShift(glitterColor.rgb, _GlitterHueShift_2121Hair0 + _Time.x * (0.0 /*_GlitterHueShiftSpeed*/), (0.0 /*_GlitteHueShiftColorSpace*/));
					}
