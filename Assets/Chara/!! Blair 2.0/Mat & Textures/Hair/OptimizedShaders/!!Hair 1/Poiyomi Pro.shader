Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/856bf5562a31dff4a9e2b0c5f5be4182"
{
	Properties
	{
		...
		_Matcap3HueShift_2121Hair1 ("Hue Shift", Range(0, 1)) = 0
		...
		[HDR]_EmissionColor_2121Hair1 ("Emission Color--{reference_property:_EmissionColorThemeIndex}", Color) = (1, 1, 1, 1)
		...
		_EmissionStrength_2121Hair1 ("Emission Strength", Range(0, 20)) = 0
		...
		_EmissionHueShift_2121Hair1 ("Hue Shift", Range(0, 1)) = 0
		...
		_GlitterHueShift_2121Hair1 ("Hue Shift", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _Matcap3HueShift_2121Hair1;
			...
			float _GlitterHueShift_2121Hair1;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					matcap3.rgb = hueShift(matcap3.rgb, _Matcap3HueShift_2121Hair1 + _Time.x * (0.0 /*_Matcap3HueShiftSpeed*/), (0.0 /*_Matcap3HueShiftColorSpace*/));
				}
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = _EmissionStrength_2121Hair1;
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor_2121Hair1.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor_2121Hair1.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor_2121Hair1.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				emissionColor0 = hueShift(emissionColor0, frac(_EmissionHueShift_2121Hair1 + (0.0 /*_EmissionHueShiftSpeed*/) * _Time.x) * (1.0 /*_EmissionHueShiftEnabled*/), (0.0 /*_EmissionHueShiftColorSpace*/));
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (int glitterLayer = 0; glitterLayer < (2.0 /*_GlitterLayers*/); glitterLayer++)
				{
					...
					{
						glitterColor.rgb = hueShift(glitterColor.rgb, _GlitterHueShift_2121Hair1 + _Time.x * (0.0 /*_GlitterHueShiftSpeed*/), (0.0 /*_GlitteHueShiftColorSpace*/));
					}
