Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/463725fb580003a46bb8fdb8f8e62cb6"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_Matcap3SmoothnessEnabled*/))
				{
					float mipCount3 = 9;
					...
					float matcap3Smoothness = (0.55 /*_Matcap3Smoothness*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (1.0 /*_Matcap3Multiply*/), (1.0 /*_Matcap3Replace*/), (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP3
				...
				if ((1.0 /*_Matcap4SmoothnessEnabled*/))
				{
					float mipCount4 = 9;
					...
					float matcap4Smoothness = (0.55 /*_Matcap4Smoothness*/);
				...
				#endif
				matcapIntensity = (2.2 /*_Matcap4Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.77 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.0 /*_Matcap4Multiply*/), (0.028 /*_Matcap4Replace*/), (0.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
