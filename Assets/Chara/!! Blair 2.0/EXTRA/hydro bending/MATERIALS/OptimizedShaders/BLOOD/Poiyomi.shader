Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/235dc0119463d1142b1146378b8c47ee"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					matcap.rgb = hueShift(matcap.rgb, (0.422 /*_MatcapHueShift*/) + _Time.x * (0.0 /*_MatcapHueShiftSpeed*/));
				}
