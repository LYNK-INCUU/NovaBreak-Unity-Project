...
namespace cowsins
{
    ...
    public class UIEvents
    {
        ...
        public static Action forbiddenInteraction, disableInteractionUI, onFinishInteractionProgress, onDashGained, disableWeaponUI, enableWeaponDisplay, onStartInspection, onStopInspection;
